...
public class PhotoAdapterFirst extends RecyclerView.Adapter<PhotoAdapterFirst.ViewHolder>{
    ...
    public PhotoAdapterFirst(List<QueryDocumentSnapshot> fotosList, Context context) {
    ...
    @Override
    public void onBindViewHolder(@NonNull PhotoAdapterFirst.ViewHolder holder, int position) {
                        ...
                        nombreTextView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                if (itemClickListener != null) {
                                    ...
                                    String idDocumento =username;

                                    itemClickListener.onItemClick(idDocumento);
                                } else{
