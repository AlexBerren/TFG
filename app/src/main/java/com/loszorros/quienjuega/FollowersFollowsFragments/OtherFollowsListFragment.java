...
public class OtherFollowsListFragment extends Fragment {
    ...
    public OtherFollowsListFragment() {
        // Required empty public constructor
    }

    public static OtherFollowsListFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_other_follows_list, container, false);
        ...
        DocumentReference usuariosRef = db.collection("users").document(idDocumento).collection("follows").document("usernames");
